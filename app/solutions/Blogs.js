    ...
    <div className="w-full px-5">
      <div className="py-10 md:py-20 max-w-[1160px] w-full mx-auto">
        <div className="flex flex-col text-center gap-4" data-aos="fade-up">
          <div
            className="shadow-custom border border-border bg-white rounded-[1000px] mx-auto px-3 py-1 max-w-[82px] flex items-center gap-1.5"
            data-aos="fade-up"
          >
            <Image
          ...
          <h1
            className="max-w-[621px] mx-auto text-heading text-[40px] sm:text-[52px] sm:leading-[65px] tracking-[-0.01em] font-medium"
            data-aos="fade-up"
          >
            Our Articles For Company Creators
          </h1>
          <p
            className="text-secondaryText text-[16px] sm:text-[16px] sm:leading-[27px] font-normal"
            data-aos="fade-up"
          >
          ...
          {blogs.slice(0, 3).map((blog) => (
            <div key={blog.id} data-aos="fade-up">
              ...
              <div className="mt-4 md:mt-6 flex flex-col gap-2">
                <Link href={`/blog/${blog.id}`}>
                  <h4 className="text-secondaryText text-[16px] leading-[25px] font-medium">
                    {blog.title}
                  </h4>
                </Link>
                <Link href={`/blog/${blog.id}`}>
                  <h2 className="text-heading text-[24px] leading-[30px] font-medium">
                    {blog.headline}
                  </h2>
                </Link>
                <div className="flex items-center gap-2">
                  <h3 className="text-secondaryText text-[16px] leading-[25px]">
                    {blog.date}
                  </h3>
                  <Image
