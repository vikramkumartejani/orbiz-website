...
const OptimizeRevenue = () => {
  return (
    <div className="p-4 md:p-8">
      <div className="bg-whitish py-14 md:py-20 rounded-[24px] border border-[#ECEFF3]">
        <div className="flex flex-col text-center gap-4 px-5">
          <div
            className="shadow-custom border border-borderColor bg-white rounded-[1000px] mx-auto px-3 py-1 max-w-[113px] flex items-center gap-1.5"
            data-aos="fade-up"
          >
            <Image
          ...
          <h1
            className="max-w-[627px] mx-auto text-heading text-[40px] sm:text-[52px] sm:leading-[65px] tracking-[-0.01em] font-medium"
            data-aos="fade-up"
            data-aos-delay="100"
          >
          ...
          <p
            className="text-secondaryText text-[16px] sm:text-[16px] sm:leading-[27px] font-normal max-w-[530px] mx-auto"
            data-aos="fade-up"
            data-aos-delay="200"
          >
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-[1160px] mx-auto w-full px-4">
          ...
          >
            <Image
              ...
              height={52}
            />
            <h1 className="text-heading text-[24px] leading-[31px] font-medium mt-6 pb-3">
              Instant Payouts
            </h1>
            <p className="text-secondaryText text-[16px] leading-[27px] font-normal">
