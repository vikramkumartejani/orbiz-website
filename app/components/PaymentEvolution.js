...
const PaymentEvolution = () => {
  return (
    <div className="w-full px-2 md:px-5 pb-5 overflow-hidden">
      <div
        className="w-full border border-borderColor rounded-[24px] shadow-custom-one px-4"
        data-aos="fade-up"
      >
        <div className="max-w-[1200px] w-full mx-auto py-12 md:py-[88px]">
          <div className="w-full max-w-[550px] mx-auto text-center">
            <div
              className="border border-borderColor shadow-custom-one rounded-[1000px] w-[107px] h-[30px] mx-auto flex items-center justify-center gap-1.5"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <Image
            ...
            <h1
              className="text-heading text-[35px] sm:text-[52px] sm:leading-[65px] font-medium tracking-[-0.01em] mt-4"
              data-aos="fade-up"
              data-aos-delay="200"
            >
            ...
            <p
              className="text-secondaryText text-[18px] sm:leading-[27.9px] font-normal mt-4"
              data-aos="fade-up"
              data-aos-delay="300"
            >
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div data-aos="fade-up" data-aos-delay="400">
              ...
              />
              <h2 className="text-heading text-[20px] md:text-[24px] leading-[31.4px] font-medium mb-2">
                SaaS Solution
              </h2>
              <p className="text-secondaryText text-[16px] md:leading-[27.9px] font-normal">
