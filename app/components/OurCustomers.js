      ...
      <div className="max-w-[1200px] w-full mx-auto py-12 md:py-[88px]">
        <div className="flex lg:items-end lg:flex-row flex-col justify-between gap-4 w-full">
          <div data-aos="fade-right">
            ...
            <h1 className="mt-4 max-w-[369px] text-[#0D0D12] text-[52px] leading-[65px] tracking-[-0.01em] font-medium">
          ...
          <div
            ...
            data-aos="fade-left"
          >
            <p className="text-[#666D80] text-[16px] leading-[27.9px] font-normal">
        ...
        <div className="pt-10 md:pt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 xl:gap-6">
          <div
            className="bg-[#F8FAFB] border border-[#ECEFF3] rounded-[16px] p-5 md:p-4 xl:p-6"
            data-aos="fade-up"
          >
            <p className="text-[#0D0D12] text-[19px] leading-[28px] font-medium mb-8">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <div>
                <h1 className="text-[#0D0D12] text-[15px] leading-[25.6px] font-medium">
                  Soós Annamária
                </h1>
                <h3 className="text-[#666D80] text-[14px] leading-[21.7px] font-normal">
