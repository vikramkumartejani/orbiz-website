  ...
  return (
    <div className='min-w-[220px] md:block hidden'>
      ...
      <div>
        ...
        <button className='text-[#0D0D12] text-[14px] leading-[21px] font-semibold border border-[#DFE1E7] bg-[#FFFFFF] w-[120px] h-[40px] rounded-[1000px] mt-4'>Request App</button>
      </div>
    </div>
  );
}
