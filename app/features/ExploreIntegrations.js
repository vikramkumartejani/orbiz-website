    ...
    return (
        <div className='w-full md:pt-14 py-10 md:pb-20 flex md:flex-col flex-col-reverse'>
            ...
            <div className='md:mt-10 flex flex-col gap-4 items-center text-center px-5'>
                <div className="shadow-custom border border-[#DFE1E7] bg-white rounded-[1000px] mx-auto px-3 py-1 max-w-[118px] flex items-center gap-1.5">
                    <Image src="/assets/icons/file-text.svg" alt="file-text" width={13.33} height={13.33} className='-mt-0.5' />
                    <h1 className="text-[#5F57FF] text-[13px] leading-[21.7px] font-medium font-custom">Integrations</h1>
                </div>
                <h1 className='text-[#0D0D12] text-[35px] sm:text-[52px] sm:leading-[65px] tracking-[-0.01em] font-medium max-w-[668px]'>Simplify Your Workflow with Orbiz Integrations</h1>
                <p className='text-[#666D80] text-[16px] sm:text-[18px] sm:leading-[27.9px] font-normal'>Connect over 80+ partner tools available. Focus on what matters.</p>
                <button className='mt-4 bg-[#5F57FF] px-6 w-full sm:w-[210px] h-[48px] rounded-[1000px] text-white text-[16px] leading-[24px] font-semibold'>Explore Integrations</button>
            </div>
        </div>
    )
}
